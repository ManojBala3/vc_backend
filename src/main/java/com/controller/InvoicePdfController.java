   ...
   //String filepath="E:\\";
    ...
    public ByteArrayInputStream get(AddPrescriptionRequest presp) {
        ...
        try {
            ...
            Font venabheader = FontFactory.getFont(filepath.concat("Segoe.ttf"), BaseFont.IDENTITY_H, BaseFont.EMBEDDED);
           ...
           // boldFontS.setStyle(Font.BOLD);
            ...
            Font normalFontL = FontFactory.getFont(filepath.concat("Segoe.ttf"), BaseFont.IDENTITY_H, BaseFont.EMBEDDED); 
            normalFontL.setSize(10);
            normalFontL.setStyle(Font.NORMAL);
            Font normalFontH =FontFactory.getFont(filepath.concat("Segoe.ttf"), BaseFont.IDENTITY_H, BaseFont.EMBEDDED); 
           ...
           // Font tamilFont = FontFactory.getFont("/home/ec2-user/Tamil003.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED);
        	...
        	String arr[]=adjustspace(presp.getCustomername().length()+6,age.length()+5,presp.getPatientid().length()+5,0);
...
//            //myReportTable.addCell(tableCell6);
            ...
            if(presp.getWeight()==0)
            	...
            	table2_cell2 = createPdfPCellWithPhrase2("Weight: ",presp.getWeight()+"".concat("kg"),boldFont1, normalFont);
            ...
            if(presp.getWeight()==0)
            	...
            	table2_cell4 = createPdfPCellWithPhrase2("Height: ",presp.getHeight()+"".concat("cm"),boldFont1, normalFont);
            ...
            if(presp.getWeight()==0)
            	...
            	table2_cell6 = createPdfPCellWithPhrase2("HC: ",presp.getHc()+"".concat("cm"), boldFont1,normalFont);
            ...
            Chunk chunk3= new Chunk("Medications & Advice:", boldFont2);
           ...
           // tablecheckup18.setBorder(Rectangle.NO_BORDER);
            ...
            for(int i=0;i<presp.getProducts().size();i++)
            {
                ...
                {
                	 PdfPCell tablecheckup22 = createPdfPCellWithPhrase(convertinttostr(pd.getMorning(),value), normalFontL);
                     tablecheckup22.setHorizontalAlignment(Element.ALIGN_CENTER);
                     tablecheckup22.setFixedHeight(30f);
                     tablecheckup22.setPaddingTop(5);
                     treatmenttable.addCell(tablecheckup22);
